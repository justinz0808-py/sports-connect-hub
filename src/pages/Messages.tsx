  ...
  return (
    <div className="min-h-screen pt-14 pb-20">
      <div className="px-4 pt-4">
        <h1 className="text-2xl tracking-wide mb-4">MESSAGES</h1>
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2">
                  <span className={`text-sm truncate tracking-wide ${c.unread ? 'text-foreground' : 'text-muted-foreground'}`}>{c.name}</span>
